# INeptuneRouterV1.sol

View Source: [contracts/examples/.router/INeptuneRouter.sol](../contracts/examples/.router/INeptuneRouter.sol)

**↘ Derived Contracts: [NeptuneRouterV1](NeptuneRouterV1.md)**
...
```javascript
function addCovers(ICover.AddCoverArgs[] calldata args) external returns (address[] memory vaults);
```
</details>
...
```javascript
function addProducts(ICover.AddProductArgs[] calldata args) external;
```
</details>
...
```javascript
function purchaseCovers(IPolicy.PurchaseCoverArgs[] calldata args) external;
```
</details>
...
```javascript
function addLiquidities(IVault.AddLiquidityArgs[] calldata args) external;
```
</details>
