...
- [constructor()](#)
- [transferGovernance(bytes32 , address sender, uint256 amount)](#transfergovernance)
...
```solidity
function transferGovernance(bytes32 , address sender, uint256 amount) external nonpayable
```
