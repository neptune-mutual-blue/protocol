...
module.exports = {
  ...
  efficiency: helper.percentage(80),
  tags: ['exchange', 'dex', 'swap', 'aggregation'],
  about: 'The 1inch Network brings together decentralized protocols that work synergistically to provide efficient, secure operations in the DeFi space. It offers access to a multitude of liquidity sources across various chains. The 1inch Network was launched at the ETHGlobal New York hackathon in May 2019 with the release of its Aggregation Protocol v1. Since then, the 1inch Network has added more DeFi tools to its repertoire, including the Liquidity Protocol, Limit Order Protocol, P2P transactions, and the 1inch Mobile Wallet.',
  blockchains: [
    {
      chainId: 56,
      name: 'BNB Chain'
  ...
  parameters: [
    {
      ...
      list: {
        type: 'unordered',
        items: [
          'This policy relates exclusively to the 1inch v2 protocol deployed on the BNB Smart Chain.',
