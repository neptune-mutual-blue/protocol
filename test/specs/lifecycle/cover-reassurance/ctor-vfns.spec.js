...
describe('CoverReassurance: Constructor', () => {
  ...
  it('correctly deploys', async () => {
    const cover = await deployer.deployWithLibraries(cache, 'CoverReassurance',
      {
    ...
    name.should.equal(key.PROTOCOL.CNAME.COVER_REASSURANCE)
  })
})
