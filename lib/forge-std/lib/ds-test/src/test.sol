...
contract DSTest {
    ...
    function assertEqDecimal(uint256 a, uint256 b, uint256 decimals)
        internal
    {
        if (a != b) {
    ...
    function assertGtDecimal(uint256 a, uint256 b, uint256 decimals)
        internal
    {
        if (a <= b) {
            emit log("Error: a > b not satisfied [decimal uint]");
    ...
    function assertGeDecimal(uint256 a, uint256 b, uint256 decimals)
        internal
    {
        if (a < b) {
            emit log("Error: a >= b not satisfied [decimal uint]");
    ...
    function assertLtDecimal(uint256 a, uint256 b, uint256 decimals)
        internal
    {
        if (a >= b) {
            emit log("Error: a < b not satisfied [decimal uint]");
    ...
    function assertLeDecimal(uint256 a, uint256 b, uint256 decimals)
        internal
    {
        if (a > b) {
            emit log("Error: a <= b not satisfied [decimal uint]");
