...
contract StdAssertionsTest is Test {
    ...
    function testAssertEq_IntArr_Pass(int256 e0, int256 e1, int256 e2)
        public
    {
    ...
    function testAssertEq_UintArr_FailLen(uint256 lenA, uint256 lenB)
        public
    {
        vm.assume(lenA != lenB);
    ...
    function testAssertEq_IntArrErr_FailLen(uint256 lenA, uint256 lenB)
        public
    {
        vm.assume(lenA != lenB);
        vm.assume(lenA <= 10000);
